...
local menu
do
    local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/DiscIssues/corzn/main/cw%20menu.lua"))()

    menu = library.new([[cripware <font color="rgb(0, 0, 255)">v1</font>]], "nemv2\\")
    local tabs = {
    ...
    do
        ...
        fov.element("Toggle", "draw fov", nil, function(State) Circle.Visible = State.Toggle end):add_color({Color = Color3.fromRGB(0, 255, 0)}, nil, function(State) Circle.Color = State.Color end)
